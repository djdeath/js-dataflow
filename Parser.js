...
"dataflow":function(){var $elf=this,$vars={},$r0=this._startStructure(1256, true);$vars.xs=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1261);}),1259);$r0.value=flatten1($vars.xs);return this._endStructure($r0);}});let DataflowExtractNodes=objectThatDelegatesTo(OMeta,{
