...
"get":function(){var $elf=this,$vars={},$r0=this._startStructure(695, true);$vars.x=this._getStructureValue(this.anything());$r0.value=(this.isNode($vars.x)?["node",$vars.x]:["get",$vars.x]);return this._endStructure($r0);}});(SetNodesTransforms["isNode"]=(function (name){return (this["_nodes"][name] === true);}));(SetNodesTransforms["setNodes"]=(function (names){(this["_nodes"]=({}));for(let i=(0);(i < names["length"]);i++){(this["_nodes"][names[i]]=true);};}))
let ExtractNodes=objectThatDelegatesTo(OMeta,{
...
"number":function(){var $elf=this,$vars={},$r0=this._startStructure(713, true);$vars.n=this._getStructureValue(this.anything());$r0.value=[];return this._endStructure($r0);},
"string":function(){var $elf=this,$vars={},$r0=this._startStructure(717, true);$vars.s=this._getStructureValue(this.anything());$r0.value=[];return this._endStructure($r0);},
"regExpr":function(){var $elf=this,$vars={},$r0=this._startStructure(721, true);$vars.x=this._getStructureValue(this.anything());$r0.value=[];return this._endStructure($r0);},
"arr":function(){var $elf=this,$vars={},$r0=this._startStructure(725, true);$vars.xs=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),730);}),728);$r0.value=$vars.xs.reduce((function (a,b){return a.concat(b);}));return this._endStructure($r0);},
"unop":function(){var $elf=this,$vars={},$r0=this._startStructure(733, true);$vars.op=this._getStructureValue(this.anything());$vars.x=this._appendStructure($r0,this._apply("trans"),737);$r0.value=$vars.x;return this._endStructure($r0);},
"getp":function(){var $elf=this,$vars={},$r0=this._startStructure(740, true);$vars.fd=this._appendStructure($r0,this._apply("trans"),743);$vars.x=this._appendStructure($r0,this._apply("trans"),746);$r0.value=$vars.fd.concat($vars.x);return this._endStructure($r0);},
"get":function(){var $elf=this,$vars={},$r0=this._startStructure(749, true);$vars.x=this._getStructureValue(this.anything());$r0.value=$vars.x;return this._endStructure($r0);},
"binop":function(){var $elf=this,$vars={},$r0=this._startStructure(753, true);$vars.op=this._getStructureValue(this.anything());$vars.x=this._appendStructure($r0,this._apply("trans"),757);$vars.y=this._appendStructure($r0,this._apply("trans"),760);$r0.value=$vars.x.concat($vars.y);return this._endStructure($r0);},
"condExpr":function(){var $elf=this,$vars={},$r0=this._startStructure(763, true);$vars.cond=this._appendStructure($r0,this._apply("trans"),766);$vars.t=this._appendStructure($r0,this._apply("trans"),769);$vars.e=this._appendStructure($r0,this._apply("trans"),772);$r0.value=$vars.cond.concat($vars.t).concat($vars.e);return this._endStructure($r0);},
"call":function(){var $elf=this,$vars={},$r0=this._startStructure(775, true);$vars.fn=this._appendStructure($r0,this._apply("trans"),778);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),783);}),781);$r0.value=$vars.args.reduce((function (a,b){return a.concat(b);}));return this._endStructure($r0);},
"send":function(){var $elf=this,$vars={},$r0=this._startStructure(786, true);$vars.msg=this._getStructureValue(this.anything());$vars.recv=this._appendStructure($r0,this._apply("trans"),790);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),795);}),793);$r0.value=trans.concat($vars.args.reduce((function (a,b){return a.concat(b);})));return this._endStructure($r0);},
"json":function(){var $elf=this,$vars={},$r0=this._startStructure(798, true);$vars.props=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),803);}),801);$r0.value=$vars.props.reduce((function (a,b){return a.concat(b);}));return this._endStructure($r0);},
"binding":function(){var $elf=this,$vars={},$r0=this._startStructure(806, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),810);$r0.value=$vars.val;return this._endStructure($r0);}});let JsGen=objectThatDelegatesTo(OMeta,{
"trans":function(){var $elf=this,$vars={},$r0=this._startStructure(814, true);this._appendStructure($r0,this._form(function(){var $r1=this._startStructure(818);$vars.t=this._getStructureValue(this.anything());$r1.value=($vars.ans=this._appendStructure($r1,this._apply($vars.t),823));return this._endStructure($r1);}),816);$r0.value=$vars.ans;return this._endStructure($r0);},
"number":function(){var $elf=this,$vars={},$r0=this._startStructure(827, true);$vars.n=this._getStructureValue(this.anything());$r0.value=(("(" + $vars.n) + ")");return this._endStructure($r0);},
"string":function(){var $elf=this,$vars={},$r0=this._startStructure(831, true);$vars.s=this._getStructureValue(this.anything());$r0.value=$vars.s.toProgramString();return this._endStructure($r0);},
"regExpr":function(){var $elf=this,$vars={},$r0=this._startStructure(835, true);$vars.x=this._getStructureValue(this.anything());$r0.value=$vars.x;return this._endStructure($r0);},
"arr":function(){var $elf=this,$vars={},$r0=this._startStructure(839, true);$vars.xs=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),844);}),842);$r0.value=(("[" + $vars.xs.join(",")) + "]");return this._endStructure($r0);},
"unop":function(){var $elf=this,$vars={},$r0=this._startStructure(847, true);$vars.op=this._getStructureValue(this.anything());$vars.x=this._appendStructure($r0,this._apply("trans"),851);$r0.value=(((("(" + $vars.op) + " ") + $vars.x) + ")");return this._endStructure($r0);},
"getp":function(){var $elf=this,$vars={},$r0=this._startStructure(854, true);$vars.fd=this._appendStructure($r0,this._apply("trans"),857);$vars.x=this._appendStructure($r0,this._apply("trans"),860);$r0.value=((($vars.x + "[") + $vars.fd) + "]");return this._endStructure($r0);},
"get":function(){var $elf=this,$vars={},$r0=this._startStructure(863, true);$vars.x=this._getStructureValue(this.anything());$r0.value=(this._isInput($vars.x)?(("values[" + $vars.x.toProgramString()) + "]"):$vars.x);return this._endStructure($r0);},
"binop":function(){var $elf=this,$vars={},$r0=this._startStructure(867, true);$vars.op=this._getStructureValue(this.anything());$vars.x=this._appendStructure($r0,this._apply("trans"),871);$vars.y=this._appendStructure($r0,this._apply("trans"),874);$r0.value=(((((("(" + $vars.x) + " ") + $vars.op) + " ") + $vars.y) + ")");return this._endStructure($r0);},
"condExpr":function(){var $elf=this,$vars={},$r0=this._startStructure(877, true);$vars.cond=this._appendStructure($r0,this._apply("trans"),880);$vars.t=this._appendStructure($r0,this._apply("trans"),883);$vars.e=this._appendStructure($r0,this._apply("trans"),886);$r0.value=(((((("(" + $vars.cond) + "?") + $vars.t) + ":") + $vars.e) + ")");return this._endStructure($r0);},
"call":function(){var $elf=this,$vars={},$r0=this._startStructure(889, true);$vars.fn=this._appendStructure($r0,this._apply("trans"),892);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),897);}),895);$r0.value=((($vars.fn + "(") + $vars.args.join(",")) + ")");return this._endStructure($r0);},
"send":function(){var $elf=this,$vars={},$r0=this._startStructure(900, true);$vars.msg=this._getStructureValue(this.anything());$vars.recv=this._appendStructure($r0,this._apply("trans"),904);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),909);}),907);$r0.value=((((($vars.recv + ".") + $vars.msg) + "(") + $vars.args.join(",")) + ")");return this._endStructure($r0);},
"json":function(){var $elf=this,$vars={},$r0=this._startStructure(912, true);$vars.props=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),917);}),915);$r0.value=(("({" + $vars.props.join(",")) + "})");return this._endStructure($r0);},
"binding":function(){var $elf=this,$vars={},$r0=this._startStructure(920, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),924);$r0.value=(($vars.name.toProgramString() + ": ") + $vars.val);return this._endStructure($r0);},
"propagate":function(){var $elf=this,$vars={},$r0=this._startStructure(927, true);$vars.name=this._getStructureValue(this.anything());$vars.expr=this._getStructureValue(this.anything());$vars.location=this._getStructureValue(this.anything());$vars.inputs=this._appendStructure($r0,this._applyWithArgs("foreign",ExtractNodes,"trans",$vars.expr),933);$vars.val=this._appendStructure($r0,this._applyWithArgs("trans",$vars.expr),938);$r0.value=["{ eval: function(values) { value[",$vars.name,"]","=",$vars.val,";}, inputs:",this._toItemString($vars.inputs),"}"].join("");return this._endStructure($r0);},
"program":function(){var $elf=this,$vars={},$r0=this._startStructure(942, true);$vars.xs=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),947);}),945);$r0.value=(("{" + $vars.xs.join(";\n")) + "}");return this._endStructure($r0);}});(JsGen["_toItemString"]=(function (inputs){let items=({});for(let i=(0);(i < inputs["length"]);i++){(items[inputs[i]]=true);}let s="[";for(let i in items){(s+=(i + ","));}(s+="]");return s;}));(JsGen["_isInput"]=(function (name){return (this["_inputs"] && (this["_inputs"][name] === true));}));(JsGen["setInput"]=(function (inputs){(this["_inputs"]=({}));for(let i=(0);(i < inputs["length"]);i++){(this["_inputs"][inputs[i]]=true);};}))
